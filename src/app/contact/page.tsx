...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Sriram Badisa for AI-assisted product engineering roles and projects.",
};
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          <aside className="gradient-border rounded-lg bg-white/[0.05] p-6">
            ...
            <h2 className="mt-5 text-3xl font-black text-white">
              Product roles, UI systems, and AI-assisted delivery.
            </h2>
            <p className="mt-4 text-base leading-8 text-slate-300">
              Reach out for opportunities where {profile.name} can help plan,
              build, refactor, debug, and ship modern product interfaces.
            </p>
          ...
          <section className="rounded-lg border border-white/10 bg-white/[0.04] p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              The form uses EmailJS and keeps required fields for name, email,
              and message.
            </p>
            <div className="mt-6">
              <ContactForm />
